package com.example.rigistrationform;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchNotif=findViewById(R.id.notificationSwitch);
        ...
        SubmitSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.isEmpty()){
                    Toast.makeText(MainActivity.this,"Pleas fill the user name field",Toast.LENGTH_SHORT).show();
                }
                else if (name.equals("Ahmed") ||name.equals("Sabbah")){
                    invalid=true;
        ...
        categoryCountry.add("Palestine");
        categoryCountry.add("Jordan");
        categoryCountry.add("Egypt");
        categoryCountry.add("UAE");
        categoryCountry.add("Saudi Arabia");
